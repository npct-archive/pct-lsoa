...
#Inputs
routes_master = readRDS("E:/OneDrive - University of Leeds/Cycling Big Data/LSOA/rf_nat_4plus_fix.Rds")
#groups_master = readRDS("../pct-lsoa/Data/03_Intermediate/groups/rf_nat_4plus_region2_finished.Rds")
flow_data = readRDS("E:/OneDrive - University of Leeds/Cycling Big Data/LSOA/LSOA_flow.Rds")
...
writeOGR(routes_master,dsn = "E:/OneDrive - University of Leeds/Cycling Big Data/LSOA/shape", layer = "rf_nat_4plus_fix", driver = "ESRI Shapefile")
