...
tempfld <- "../pct-lsoa/Data/03_Intermediate/temp/rasterise-ebike/" #Where tempry rasters are saved
outfld <- "../pct-lsoa/Data/03_Intermediate/raster-grid-ebik/" #Where results are saved
...
routes_master@data = routes_master@data[,c("ID","ebike_slc")]
remove(flow_data) #,groups_master)
routes_master = routes_master[routes_master$ebike_slc >0,]
nrow(routes_master)
